...
class SlidingWindowCounter:
    ...
    All access to the events deque is guarded by an internal lock so concurrent admit/read paths
    (e.g. the executor's window_counts gauge vs _admit) never race on the same deque.
    """
