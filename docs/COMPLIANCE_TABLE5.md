...
| 3 | Test coverage >= 85% (statement + branch) | PASS | `uv run pytest --cov` → 97.35% |
...
| 13 | Token before/after with >= 70% savings (or amortization) | PASS | 97.65% (`metrics/out/token_metrics.json`, README) |
